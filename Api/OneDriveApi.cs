...
namespace KoenZomers.OneDrive.Api
{
    ...
    public abstract class OneDriveApi
    {
        ...
        public string GetAuthorizationTokenFromUrl(string url)
        {
            ...
            //{
            //    ClientId = "233d9409-2bc0-404a-8f1e-c122a81615dc",
            //    ClientSecret = "75RqNNnIp4sf_AvaFcemiSK5~J~6~0qVL7",
            ...
            //   var authCode = GetAuthCode(client, new[] { Scope.Signin, Scope.Basic, Scope.SkyDrive });
            // url = "https://login.live.com/oauth20_authorize.srf?pretty=false&client_id=233d9409-2bc0-404a-8f1e-c122a81615dc&scope=wl.basic+wl.signin+wl.skydrive&response_type=code&redirect_uri=https:%2f%2flogin.microsoftonline.com%2fcommon%2foauth2%2fnativeclient";
        ...
        public virtual async Task<OneDriveItem> UpdateFile(string filePath, OneDriveItem oneDriveItem)
        {
            ...
            var fileToUpload = new System.IO.FileInfo(filePath);
        ...
        /// <param name="oneDriveItem">OneDriveItem of the folder to which the file should be uploaded</param>
        /// <returns>The resulting OneDrive item representing the uploaded file</returns>
        public async Task<OneDriveItem> UpdateFileViaSimpleUpload(System.IO.FileInfo file, OneDriveItem oneDriveItem)
        {
